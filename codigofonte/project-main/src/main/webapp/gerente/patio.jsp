    ...
    <script>
        ...
        function salvarNovoPatio() {
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    alert("Não foi possível adicionar o pátio: " + (xhr.responseJSON ? xhr.responseJSON.mensagem : "erro no servidor."));
                }
            });
        }
        ...
        function atualizarPatio() {
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    alert("Não foi possível atualizar o pátio: " + (xhr.responseJSON ? xhr.responseJSON.mensagem : "erro no servidor."));
                }
            });
        }
        ...
        function removerPatio() {
            ...
            if(confirm("ATENÇÃO: Deseja realmente remover este pátio?")) {
                $.ajax({
                    ...
                    error: function(xhr) {
                        alert("Não foi possível remover o pátio: " + (xhr.responseJSON ? xhr.responseJSON.mensagem : "erro no servidor."));
                    }
                });
            }
        }
