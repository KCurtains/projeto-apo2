...
<head>
    ...
    <style>
        ...
        .btn-icon-red { background-color: #dc3545; color: white; border: none; }
        .btn-icon-red:hover { background-color: #bb2d3b; color: white; }

        /* Barra de Navegação Inferior (Nova) */
        .bottom-nav {
            background-color: #ffffff;
