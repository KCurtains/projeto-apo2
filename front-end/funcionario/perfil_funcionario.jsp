...
<head>
    ...
    <style>
        ...
        .btn-orange { background-color: #f98825; color: white; font-weight: bold; border-radius: 20px; border: none; }
        .btn-orange:hover { background-color: #e07a21; color: white; }
        .btn-red { background-color: #dc3545; color: white; font-weight: bold; border-radius: 20px; border: none; }
        .btn-red:hover { background-color: #bb2d3b; color: white; }
