...
<body>
    ...
    <div class="app-container">
        ...
        <div class="content-area container-md" id="perfil-container">
            ...
            <div class="profile-block" id="block-nome">
                ...
                <div class="edit-mode d-none d-flex align-items-center mt-1">
                    <input type="text" class="form-control form-control-sm me-2" id="input-nome">
            ...
            <div class="profile-block" id="block-numero">
                ...
                <div class="edit-mode d-none d-flex align-items-center mt-1">
                    <input type="text" class="form-control form-control-sm me-2" id="input-numero">
        ...
        <div class="bottom-nav">
            ...
            <a href="perfil_funcionario.jsp" class="nav-item active"><i class="bi bi-person-circle"></i></a>
        </div>
    ...
    <script>
        ...
        function carregarPerfil() {
            $.ajax({
                url: '../funcionario?acao=buscarPerfil',
                type: 'GET',
                dataType: 'json',
                success: function(dados) {
                    $('#val-nome').text(dados.nome);
                    $('#input-nome').val(dados.nome);
                    $('#val-cpf').text(dados.cpf);
                    $('#val-email').text(dados.email);
                    $('#val-numero').text(dados.telefone);
                    $('#input-numero').val(dados.telefone);
                },
                error: function(xhr) {
                    if (xhr.status === 401) {
        ...
        function salvarSimples(campo) {
            ...
            $.ajax({
            	url: '../funcionario?acao=atualizarSimples',
                type: 'POST',
        ...
        function salvarComplexo(campo) {
            ...
            $.ajax({
            	url: '../funcionario?acao=atualizarComplexo',
                type: 'POST',
                data: JSON.stringify({
                    tipo: campo,
                    valorAtual: atual,
